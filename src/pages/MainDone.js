...
class MainDone extends Component {
...
export default connect(mapStateToProps ,{setSearchItem , setType , setRemoveItem , setItem , setStep})(MainDone)

MainDone.contextType = ThemeContext;
